...
#define BOX_USER1_NAME "12V BEC OFF"
...
// Custom high-frequency companion computer link (telemetry/custom_link.c)
#define USE_CUSTOM_LINK
#define CUSTOM_LINK_UART       SERIAL_PORT_USART1
